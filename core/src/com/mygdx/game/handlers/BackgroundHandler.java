...
public class BackgroundHandler implements Box2DSprite{
	...
	public BackgroundHandler(Box2DVehicle car, float x, float y){
		...
		backgrounds.add(new BackgroundLayer(Game.cm.getTexture("image10.png"), 10f, Game.VWIDTH, Game.VHEIGHT, car));
		backgrounds.add(new BackgroundLayer(Game.cm.getTexture("image4146.png"), 2.00f, Game.VWIDTH, Game.VHEIGHT, car));
		backgrounds.add(new BackgroundLayer(Game.cm.getTexture("image4157.png"), 3.00f, Game.VWIDTH, Game.VHEIGHT, car));
