...
public class Stage08 extends Box2DTerrain {
	...
	float x, y;
	private final String texture = "Stage08";
	private final String model = "Stage08";
	
	
	public Stage08(World w, float x, float y, float scaleX, float scaleY) {
		this.scaleX = scaleX;
		this.scaleY = scaleY;
		this.x = x;
		this.y = y;
		...
		bdFlag.position.set(59.5f, 7.1f);
