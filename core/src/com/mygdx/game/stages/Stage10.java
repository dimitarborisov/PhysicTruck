...
public class Stage10 extends Box2DTerrain {
	...
	float x, y;
	private final String texture = "Stage10";
	private final String model = "Stage10";
	
	
	public Stage10(World w, float x, float y, float scaleX, float scaleY) {
		this.scaleX = scaleX;
		this.scaleY = scaleY;
		this.x = x;
		this.y = y;
		...
		bdFlag.position.set(38.5f, 11.7f);
