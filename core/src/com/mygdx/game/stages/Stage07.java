...
public class Stage07 extends Box2DTerrain {
	...
	float x, y;
	private final String texture = "Stage07";
	private final String model = "Stage07";
	
	
	public Stage07(World w, float x, float y, float scaleX, float scaleY) {
		this.scaleX = scaleX;
		this.scaleY = scaleY;
		this.x = x;
		this.y = y;
