...
public class Stage06 extends Box2DTerrain {
	...
	float x, y;
	private final String texture = "Stage06";
	private final String model = "Stage06";
	
	
	public Stage06(World w, float x, float y, float scaleX, float scaleY) {
		this.scaleX = scaleX;
		this.scaleY = scaleY;
		this.x = x;
		this.y = y;
		...
		bdFlag.position.set(59.5f, 3.5f);
