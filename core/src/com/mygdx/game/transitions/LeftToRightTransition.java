...
public class LeftToRightTransition extends GameState {
	...
	// NEW REUSE VERSION
	public LeftToRightTransition(GameStateManager m) {
		super(m);
	...
	// OLD
	// VERSION==================================================================================================
	public LeftToRightTransition(GameStateManager m, GameState from, GameState to) {
		this(m, from, to, false, false, false, false);
	}

	public LeftToRightTransition(GameStateManager m, GameState from, GameState to, boolean updateFrom,
			boolean updateTo) {
		this(m, from, to, updateFrom, updateTo, false, false);
	}

	public LeftToRightTransition(GameStateManager m, GameState from, GameState to, boolean updateFrom, boolean updateTo,
